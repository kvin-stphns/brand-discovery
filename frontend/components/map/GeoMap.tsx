...
export default function GeoMap() {
  return (
    <div className="w-full h-[60vh] border border-black relative overflow-hidden">
      <svg viewBox="0 0 800 400" className="w-full h-full" aria-label="Retailer location readiness map">
      ...
      <div className="absolute bottom-2 right-2 text-[10px] tracking-[0.15em] text-black/60">Retailer location data pending feed access</div>
    </div>
  )
}
