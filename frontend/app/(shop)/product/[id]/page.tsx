...
export default function ProductPage() {
  ...
  const sizes = Array.isArray(product?.sizes) && product.sizes.length ? product.sizes.filter(Boolean) : ['XS', 'S', 'M', 'L', 'XL']
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-gray-600">
                    {sanitizeText(product?.description || 'Description is unavailable for this item.')}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-sm leading-relaxed text-gray-600 space-y-1">
                    {details.length ? details.map((detail: string) => <li key={detail}>• {sanitizeText(detail)}</li>) : <li>• Details are provided by the retailer.</li>}
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-gray-600">
                    {sanitizeText(product?.shipping || 'Shipping information is provided by the retailer at checkout.')}
                  </p>
                </div>
